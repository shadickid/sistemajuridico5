...
if ($verificar_datos_cliente->num_rows > 0) {
    header("location: modificar.php?idPersona=$id_persona&idPersonaFisica=$id_persona_fisica&vali=1#documentos");
} else {
    agregarEmpleadoDocumento($valordocumento, $id_persona, $tipodocumento);
    header("location: modificar.php?idPersona=$id_persona&idPersonaFisica=$id_persona_fisica&vali=5#documentos");
