...
$datosclientesFisicos = datosClientesFisicosBaja();
$datosClientesJuridico = datosClientesJuridicosBaja();
?>
    ...
    <section class="inicio">
        <div class="contenido">
            <div class="msj-container" id="msj-container">
                <h2>Listado de clientes dados de baja</h2>
                ...
                <tbody>
                    ...
                    <?php foreach ($datosclientesFisicos as $regclientefisico): ?>
                        <tr class="clienteFisico">
                            ...
                            <td>F&iacute;sica</td>
                            <td>
                                <a href="<?php echo BASE_URL ?>modules\cliente\darAltaCliente.php?idPersona=<?php echo $regclientefisico['id_persona'] ?>"
                                    class="openModal">
                    ...
                    <?php foreach ($datosClientesJuridico as $regClienteJuridico): ?>
                        <tr class="clienteJuridico">
                            ...
                            <td>
                                <a href="<?php echo BASE_URL ?>modules\cliente\darAltaCliente.php?idPersona=<?php echo $regClienteJuridico['id_persona'] ?>"
                                    class="openModal">
                                    <button class="darDeAltaButton">
                                        <i class="fi fi-rr-check"></i>
                                    </button>
