...
$clientesJ = datosClientesJuridicos();
$estado = selectall('expediente_estado', $conditional);
$tipo = selectall('expediente_tipo', $conditional);
$id_expediente = $_GET['id_expediente'];
$datosExpediente = obtenerListadoExpedienteModificar($id_expediente);
foreach ($datosExpediente as $regExpediente):
    ?>
    ...
    <section class="inicio">
        <div class="contenido">
            <div class="msj-container" id="msj-container">
                ...
                <form action="procesarExpedienteModificacion.php" method="post" id="formularioExpedienteF">

                    <div id="">

                        <input type="hidden" value="<?php echo $id_expediente; ?>" name="idExpediente">
                        <div>
                            ...
                            <input type="text" id="nroExpediente" name="nroExpediente" placeholder="Nº de Expediente"
                                class="formulario-input" value="<?php echo $regExpediente['expediente_nro'] ?>">
                        </div>
                        <div>
                            ...
                            <input type="text" id="caratula" name="caratula" placeholder="Car&aacute;tula"
                                class="formulario-input" value="<?php echo $regExpediente['expediente_nombre'] ?>">
                        </div>
                        <div>
                            <label for="fechaInicio" class="formulario-label">Fecha de Inicio:</label>
                            <input type="date" id="fechaInicioModificar" name="fechaInicio" class="formulario-input"
                                value="<?php echo $regExpediente['expediente_fecha_inicio'] ?>">
                        </div>
                        <div>
                            ...
                            <input type="date" id="fechaFin" name="fechaFin" class="formulario-input"
                                value="<?php echo $regExpediente['expediente_fecha_fin'] ?>">

                        </div>
                        <div>
                            <label for="cliente" class="formulario-label">Clientes:</label>
                            <select name="cliente" id="cliente" name="cliente" class="formulario-select">
                                <option value="0">--Seleccione--</option>

                                <?php foreach ($clientesF as $regcliente): ?>
                                <option value="<?php echo $regcliente['id_persona'] ?>"
                                    <?php if ($regcliente['id_persona'] == $regExpediente['id_persona']) echo 'selected'; ?>>
                                ...
                                <option value="<?php echo $regclientej['id_persona'] ?>"
                                    <?php if ($regclientej['id_persona'] == $regExpediente['id_persona']) echo 'selected'; ?>>
                        ...
                        <div>
                            ...
                            <select name="estadoExp" id="estadoExp" name="estadoExp" class="formulario-select">
                                ...
                                <option value="<?php echo $regestado['id_expediente_estado'] ?>"
                                    <?php if ($regestado['id_expediente_estado'] == $regExpediente['id_expediente_estado']) echo 'selected'; ?>>
                        ...
                        <div>
                            ...
                            <textarea class="formulario-input"
                                name="comentario"><?php echo $regExpediente['expediente_descripcon'] ?></textarea>
                        </div>
                    </div>
                    <div>
