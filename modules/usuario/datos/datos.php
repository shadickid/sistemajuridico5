                ...
                <div class="formulario-container">
                    <fieldset>
                        <form class="formulario-form" method="POST" action="procesarFormularioInfo.php">
                            ...
                            <input class="formulario-input" type="text" name="nombre" id="nombre" value="<?php echo $reg['persona_nombre'] ?>">
                            <label class="formulario-label" for="apellidos">Apellido: </label>
                            <input class="formulario-input" type="text" name="apellidos" id="apellidos" value="<?php echo $reg['persona_apellido'] ?>">
                            <label class="formulario-label" for="fecnac">Fecha de nacimiento: </label>
                            <input class="formulario-input" type="date" name="fecnac" id="fecnac" value="<?php echo $reg['persona_fec_nac'] ?>">
                            <label class="formulario-label" for="sex">Sexo</label>
                            <select name="sex" class="formulario-select">
                                <?php foreach ($sexo as $sex) : ?>
                                    <option value="<?php echo $sex['id_sexo']; ?>" <?php if ($sex['id_sexo'] == $reg['id_sexo']) echo 'selected'; ?>>
                                        <?php echo $sex['nombre']; ?>
                                    </option>
                                <?php endforeach ?>
                            </select>
                                        ...
                                        <td>
                                            <a href="procesarEliminarCon.php?id_contxper=<?php echo $reg3['id_contxper'] ?>">
                                                <button class="darDeBajaButton">
                                                    <img src="<?php echo BASE_URL ?>assets\icons\delete-person-outlined-interface-button.png" alt="Dar de Baja" width="14" height="14">
                                                </button>
                                            </a>
                                        </td>
                                    </tr>
                            ...
                            <table class="tablamodal">
                                ...
                                <?php foreach ($datosempleadodocumento as $reg5) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="procesarEliminarDoc.php?id_docxperso=<?php echo $reg5['id_documentoxpersona'] ?>">
                                                <button class="darDeBajaButton">
                                                    <img src="<?php echo BASE_URL ?>assets\icons\delete-person-outlined-interface-button.png" alt="Dar de Baja" width="16" height="16">
                                                </button>
                                            </a>
                                        </td>
                                    </tr>
